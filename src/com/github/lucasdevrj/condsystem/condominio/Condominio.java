...
public class Condominio {
	...
	public void construirPredio(float largura, float altura) {
		...
		if (this.getReceita().getLucro() >= precoConstrucao) {
			...
			System.out.println("PrÈdio ConstruÌdo com Sucesso!");
			System.out.println("Altura do PrÈdio: " + altura + " metros");
			System.out.println("Largura do PrÈdio: " + largura + " metros");
			...
			System.out.println("Custo da ConstruÁ„o: R$ " + precoConstrucao);
		} else {
	...
	public void aumentarTamanhoCondominio(int tamanho) {
		...
		if (tamanho > 0) {
			if (this.getReceita().getLucro() >= precoCompra) {
				...
				System.out.println("Tamanho do CondomÌnio: " + this.getTamanho() + " metros");
			} else {
	...
	public void construirPiscina(int tamanhoPiscina) {
		...
		if (this.getTamanho() > tamanhoPiscina) {
			if (this.getReceita().getLucro() >= precoConstrucao) {
				...
				System.out.println("ConstruÁ„o da Piscina Realizada com Sucesso!");
				...
				System.out.println("N˙mero Total de Piscinas no CondomÌnio: " + this.getNumeroPiscinas());
			} else {
